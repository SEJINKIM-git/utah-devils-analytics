  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0E1428", color: "#e2e8f0", fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/lineup" style={{ padding: "7px 14px", borderRadius: 8, background: "rgba(220,38,38,0.12)", color: "#FF3B3B", fontSize: 12, fontWeight: 600, textDecoration: "none" }}>
                {lang === "ko" ? "⚾ 라인업" : "⚾ Lineup"}
              </Link>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 20px" }}>
        <GameCalendar games={games} lang={lang} />
      </div>
    </div>
  );
}