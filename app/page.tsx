        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/upload" style={{ padding: "8px 16px", borderRadius: 8, background: "rgba(59,130,246,0.18)", color: "#60a5fa", fontSize: 14, fontWeight: 700, textDecoration: "none", border: "1px solid rgba(59,130,246,0.35)" }}>{lang === "ko" ? "📤 업로드" : "📤 Upload"}</Link>
