        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
              <PlayerManager players={players || []} lang={lang} />
              ...
              <Link href="/files" style={{ padding: "8px 16px", borderRadius: 8, background: "rgba(34,197,94,0.12)", color: "#4ade80", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>{lang === "ko" ? "📂 파일 관리" : "📂 Files"}</Link>
